> **Note (this repo):** this file is the implementation spec for an unrelated
> **sibling variant** of this app ("GEM Preview Report", built as a fork of
> NLOW on the old Perplexity Labs workspace). It does not describe the app in
> this repository (title "NLOW Zoom Preview Report") — the branding, prices,
> broadcast templates, and file paths below are for that other build. Kept
> here for historical reference only. See `CLAUDE.md` for docs on this repo.
